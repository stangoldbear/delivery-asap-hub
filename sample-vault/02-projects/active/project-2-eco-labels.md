---
# Hand-written card: inline comments and a block scalar must survive a save.
id: project-2-eco-labels
type: project
name: Eco labels & durability sheet
tier: tier-1              # tier-1 = core & compliance
priority: 2
...
dates:
  started: 2026-08-18
  mandatory_deadline: 2026-12-15   # hard regulatory date
  target_delivery: 2026-12-01
  deadline_text: 2026-12-01
  deadline_type: hard
tech_footprint:
  platforms: [iOS, Android, Content]
  qa_effort: medium
  content_impact: true
stakeholders:
...
todos:
  - id: todo-project-2-eco-labels-1-1788000010
